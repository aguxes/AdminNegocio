...
public class AppController {
    ...
    private View.prueba.VentanaEmpleado ventanaEmpleado;
    private View.prueba.VentanaProducto ventanaProducto;
    private View.prueba.VentanaVentas ventanaVentas;
    private View.prueba.VentanaClientes ventanaClientes;

    @FXML
    public void initialize() {
        ventanaProducto = new View.prueba.VentanaProducto(contenedor, outputArea);
